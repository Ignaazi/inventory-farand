...
<aside 
    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto" x-data="{ openRequest: false }">
        ...
        <div>
            ...
            <div x-show="openRequest" x-cloak class="mt-1 ml-6 space-y-1 border-l border-slate-700">
                <a href="#" class="flex items-center px-4 py-2 text-xs font-medium text-slate-400 hover:text-white hover:bg-slate-800 rounded-r-md transition-all group">
                    <svg class="w-4 h-4 mr-2 text-slate-600 group-hover:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                    Request
                </a>
                <a href="#" class="flex items-center px-4 py-2 text-xs font-medium text-slate-400 hover:text-white hover:bg-slate-800 rounded-r-md transition-all group">
                    <svg class="w-4 h-4 mr-2 text-slate-600 group-hover:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    Approval
                </a>
            </div>
        </div>

        <a href="#" class="flex items-center px-4 py-3 rounded-lg text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-white group transition-all">
